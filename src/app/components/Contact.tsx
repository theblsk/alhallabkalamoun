    ...
    <section id="contact" className="py-20 bg-navy-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-up-optimized">
          ...
          <p className="text-lg text-navy-700 max-w-2xl mx-auto">{t("contact.subtitle")}</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center card-hover animate-stagger-fast-1">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-2">{t("contact.phone")}</h3>
            <p className="text-navy-600 mb-4">{t("contact.orders")}</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center card-hover animate-stagger-fast-2">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-2">{t("contact.location")}</h3>
            <p className="text-navy-600 mb-4">{t("contact.branch")}</p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center card-hover animate-stagger-fast-3">
            ...
            <h3 className="text-xl font-bold text-navy-900 mb-2">{t("contact.hours")}</h3>
            <p className="text-navy-600 mb-4">{t("contact.hours.daily")}</p>
        ...
        <div className="text-center mt-12 animate-stagger-fast-4">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-navy-900 mb-4">
              {t("franchise.name")} - {t("hero.branch.location")}
            </h3>
            <p className="text-navy-700 mb-6">{t("franchise.tagline")}</p>
            <button
              onClick={handleCallClick}
